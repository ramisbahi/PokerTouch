...
class HandsViewController: UIViewController {
    ...
    */
    ...
    /*
    @IBOutlet weak var P7C1: UIImageView!
    @IBOutlet weak var P7C2: UIImageView!
    @IBOutlet weak var P8C1: UIImageView!
    @IBOutlet weak var P8C2: UIImageView!
    @IBOutlet weak var P9C1: UIImageView!
    @IBOutlet weak var P9C2: UIImageView!
    */
